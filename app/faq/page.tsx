...
const FAQ_ITEMS = [
  ...
  },
  {
    ...
    a: '$99 за кожну спробу. Тобто перескладання — це ще $99. Саме тому варто добре підготуватись заздалегідь: цей тренажер допомагає скласти з першого разу й не платити двічі.',
  },
  {
    q: 'Скільки спроб дозволено?',
    a: 'Кожна спроба оплачується окремо ($99). Точні умови повторного складання (витримка між спробами тощо) дивись на офіційному сайті Anthropic — вони можуть змінюватись.',
  },
  {
